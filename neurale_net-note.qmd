...
format:
    html:
      #husk at slette nedenstående kommentering når quarto 1.3 kommer
      #self-contained: true 
      toc: true
      toc-title: Indhold
      toc-location: left
...
::: {#fig-sliding_window layout-nrow=3}
...
vandret linjer i et billede er vist i @tbl-feature_maps.

::: {#tbl-feature_maps layout-ncol=2}
```{r}
...
Eksempler på feature maps. Venstre: Et feature map $f_1$, som kan finde vandrette linjer i billeder. Højre: Et feature map $f_2$, som kan finde lodrette linjer i billeder.
:::
...
# Noten som pdf
[Noten om kunstige neurale netværk](./neuralenet_v3.pdf) (pdf-fil).
