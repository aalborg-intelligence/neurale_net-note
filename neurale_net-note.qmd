...
&= o \cdot (1-o) \cdot w_1\end{aligned}
$$ {#eq-dodz_1}
...
$$
\begin{aligned}
b_j^{(\text{lag})} \leftarrow b_j^{(\text{lag})} - \eta \cdot \delta_j^{(\text{lag})} \end{aligned}
$$
:::
...
#| warning: false
#| fig-cap-location: margin
#| fig-cap: Eksempler på feature maps.
#| fig-subcap:
#|   - Et feature map $f_1$, som kan finde vandrette linjer i billeder.
#|   - Et feature map $f_2$, som kan finnde lodrette linjer i billeder.
