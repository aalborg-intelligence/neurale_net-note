...
set_all_borders(f2)
```
Eksempler på feature maps. Øverst: Et feature map $f_1$, som kan finde vandrette linjer i billeder. Nederst: Et feature map $f_2$, som kan finde lodrette linjer i billeder.
:::
